window.addEventListener('load', function () {
    ...
    const updateAttr = (value) => {
        bgImg.setAttribute('src', `${descArr[value - 1].src}`);
        descTitle.innerText = descArr[value - 1].title;
        descContent.innerText = descArr[value - 1].content;
    };
});